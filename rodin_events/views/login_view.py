...
class LoginView(ctk.CTkFrame):
    ...
    def handle_login(self):
        ...
        # Conexão segura com o Supabase Auth
        SUPABASE_URL = "https://pbmwrbehvvqwnwbvhdpk.supabase.co"
        SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBibXdyYmVodnZxd253YnZoZHBrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg3Nzg0MDAsImV4cCI6MjA5NDM1NDQwMH0.0lMfAJoIi1f-R73VrPoe3gQzbKHgQiH1n9Md6KeDc3g"
        ...
        try:
            ...
            self.error_label.configure(text="Erro de conexão com o servidor")
